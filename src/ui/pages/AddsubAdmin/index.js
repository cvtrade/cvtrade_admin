                            ...
                            <form>
                                ...
                                <div className="row gx-3 mb-3">
                                    <div className="col-md-6">
                                        <label className="small mb-1" for="inputEmailAddress">Email or Phone Number<em>*</em></label>
                                ...
                                <button className="btn btn-indigo" type="button" onClick={() => handleSubAdmin(firstName, lastName, signId, passwords, confirmPassword, multipleSelectd)} > Submit Details </button>
                            </form>
                        </div>
                    </div>
                </div>
